...
public class MainScreenController implements Initializable {
    ...
    public void addDummyData() {
        ...
        Product dummyProduct = new Product(4, "Bicycle", 3, 150.00, 1, 5);
        Product dummyProduct2 = new Product(5, "Tricycle", 5, 100.00, 1, 10);
    ...
    public void onModifyProductClicked(ActionEvent event) throws IOException {
        ...
        modifyProductFormController.fillProductFields(SP);
